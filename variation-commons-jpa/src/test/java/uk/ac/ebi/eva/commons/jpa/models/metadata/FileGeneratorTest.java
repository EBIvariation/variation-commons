...
public class FileGeneratorTest {
    ...
    public void testConstructorNoTitle() {
        assertThrows(NullPointerException.class, () -> new Study(null, "Alias", "Description", Study.Material.DNA, Study.Scope.OTHER));
    }

    @Test
    public void testConstructorNoAlias() {
        assertThrows(NullPointerException.class, () -> new Study("Title", null, "Description", Study.Material.DNA, Study.Scope.OTHER));
    }

    @Test
    public void testConstructorNoDescription() {
        assertThrows(NullPointerException.class, () -> new Study("Title", "Alias", null, Study.Material.DNA, Study.Scope.OTHER));
    }

    @Test
    public void testConstructorNoMaterial() {
        assertThrows(NullPointerException.class, () -> new Study("Title", "Alias", "Description", null, Study.Scope.OTHER));
    }

    @Test
    public void testConstructorNoScope() {
        assertThrows(NullPointerException.class, () -> new Study("Title", "Alias", "Description", Study.Material.DNA, null));
    }
