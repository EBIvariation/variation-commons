...
public abstract class VariantEntityRepositoryFilter<T> {
    ...
    private final boolean useElemMatch;
    private final T value;
    private final RelationalOperator operator;

    public VariantEntityRepositoryFilter(String field, boolean useElemMatch, T value, RelationalOperator operator) {
        this.field = field;
        this.useElemMatch = useElemMatch;
        this.value = value;
    ...
    private Criteria buildElemMatchCriteria() {
        ...
        switch (operator) {
            ...
            case LTE:
                ...
                break;
            case IN:
                condition.in((Collection) value);
                break;
            default:
                throw new IllegalArgumentException();
        }
        return where.elemMatch(condition);
    }
