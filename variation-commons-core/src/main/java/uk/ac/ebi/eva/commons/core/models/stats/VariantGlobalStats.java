...
/**
 * Basic implementation of {@link IVariantGlobalStats}
 */
public class VariantGlobalStats implements IVariantGlobalStats {
    ...
    public VariantGlobalStats(IVariantGlobalStats variantGlobalStats) {
        this(
                variantGlobalStats.getVariantsCount(),
                variantGlobalStats.getSamplesCount(),
                variantGlobalStats.getSnpsCount(),
                variantGlobalStats.getIndelsCount(),
                variantGlobalStats.getStructuralCount(),
                variantGlobalStats.getPassCount(),
                variantGlobalStats.getTransitionsCount(),
                variantGlobalStats.getTransversionsCount(),
                variantGlobalStats.getMeanQuality() * variantGlobalStats.getVariantsCount(),
                variantGlobalStats.getMeanQuality(),
    ...
    public void update(VariantStatistics stats) {
        variantsCount++;
