...
public class VariantCoreFieldsTest {
    ...
    @Test
    public void testSnp() {
        VariantCoreFields snp = new VariantCoreFields("chr1", 1000L, "A", "C", false);
    ...
    public void testSingleNucleotideInsertions() {
        ...
        VariantCoreFields insertion = new VariantCoreFields("chr1", 1000, "A", "TA", false);
        ...
        insertion = new VariantCoreFields("chr1", 1000, "A", "AT", false);
        assertEquals("chr1", insertion.getChromosome());
    ...
    public void testSingleNucleotideDeletions() {
        // nucleotide inserted before context nucleotide
        VariantCoreFields deletion = new VariantCoreFields("chr1", 1000, "TA", "A", false);
        ...
        deletion = new VariantCoreFields("chr1", 1000, "TA", "T", false);
        assertEquals("chr1", deletion.getChromosome());
    ...
    public void testMNVs() {
        ...
        VariantCoreFields insertion = new VariantCoreFields("chr1", 1000, "TCACCC", "TGACGG", false);
        assertEquals("chr1", insertion.getChromosome());
        assertEquals(1001, insertion.getStart());
        ...
        insertion = new VariantCoreFields("chr1", 1000, "TCACCC", "TGACGC", false);
        assertEquals("chr1", insertion.getChromosome());
        assertEquals(1001, insertion.getStart());
    ...
    public void testMultiNucleotideInsertions() {
        ...
        VariantCoreFields insertion = new VariantCoreFields("chr1", 1000, "A", "ATCT", false);
        assertEquals("chr1", insertion.getChromosome());
        assertEquals(1001, insertion.getStart());
        ...
        insertion = new VariantCoreFields("chr1", 1000, "AT", "ATC", false);
        assertEquals("chr1", insertion.getChromosome());
    ...
    public void testMultiNucleotideDeletions() {
        // nucleotide inserted before context nucleotide
        VariantCoreFields deletion = new VariantCoreFields("chr1", 1000, "GATC", "G", false);
        assertEquals("chr1", deletion.getChromosome());
        assertEquals(1001, deletion.getStart());
        ...
        // several common nucleotides
        deletion = new VariantCoreFields("chr1", 1000, "ATC", "TC", false);
        assertEquals("chr1", deletion.getChromosome());
        assertEquals(1000, deletion.getStart());
        assertEquals(1000, deletion.getEnd());
        assertEquals("A", deletion.getReference());
    ...
    public void testOtherIndels() {
        VariantCoreFields deletion = new VariantCoreFields("chr1", 1000, "CGATT", "TAC", false);
        assertEquals("chr1", deletion.getChromosome());
        assertEquals(1000, deletion.getStart());
        ...
        deletion = new VariantCoreFields("chr1", 1000, "ATC", "AC", false);
        assertEquals("chr1", deletion.getChromosome());
        assertEquals(1001, deletion.getStart());
        assertEquals(1001, deletion.getEnd());
        assertEquals("T", deletion.getReference());
