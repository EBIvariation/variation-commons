...
public class DefaultLocusRangeMetadataServiceTest {
    ...
    @Test
    public void testFindAllByOrderByChromosomeAscStartAscEndAscSize() throws Exception {
        List<DefaultLocusRangeMetadata> defaultLocusRangeMetadataMongoList = service.findAllByOrderByChromosomeAscStartAscEndAsc();
