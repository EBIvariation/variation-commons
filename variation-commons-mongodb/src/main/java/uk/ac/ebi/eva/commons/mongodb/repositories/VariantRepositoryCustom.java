...
interface VariantRepositoryCustom {
     ...
     */
    List<VariantMongo> findByIdsAndComplexFilters(List<String> geneIds, List<VariantRepositoryFilter> filters,
                                                  List<String> exclude,
                                                  Pageable pageable);

    Long countByIdsAndComplexFilters(List<String> geneIds, List<VariantRepositoryFilter> filters);
